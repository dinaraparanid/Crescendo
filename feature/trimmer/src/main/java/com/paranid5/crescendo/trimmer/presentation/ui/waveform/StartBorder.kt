...
private fun Modifier.startBorderDragInput(
    ...
    var startMillis by remember {
        mutableLongStateOf(state.playbackPositions.startPosInMillis)
    }
    ...
    return this
        ...
        .pointerInput(Unit) {
            detectHorizontalDragGestures(
                ...
                val newPosition = (startMillis + dragUpd)
                    .toLong()
                    .coerceIn(0 until endMillis)

                onUiIntent(TrimmerUiIntent.Positions.UpdateStartPosition(newPosition))
                startMillis = newPosition
            }
        }
}
