...
set(ffmpeg_src
        ...
        ${CMAKE_CURRENT_SOURCE_DIR}/${FFMPEG_NAME}/fftools/ffmpeg_dec.c
        ${CMAKE_CURRENT_SOURCE_DIR}/${FFMPEG_NAME}/fftools/ffmpeg_demux.c
        ${CMAKE_CURRENT_SOURCE_DIR}/${FFMPEG_NAME}/fftools/ffmpeg_enc.c
        ${CMAKE_CURRENT_SOURCE_DIR}/${FFMPEG_NAME}/fftools/ffmpeg_filter.c
        ${CMAKE_CURRENT_SOURCE_DIR}/${FFMPEG_NAME}/fftools/ffmpeg_hw.c
        ${CMAKE_CURRENT_SOURCE_DIR}/${FFMPEG_NAME}/fftools/ffmpeg_mux.c
        ${CMAKE_CURRENT_SOURCE_DIR}/${FFMPEG_NAME}/fftools/ffmpeg_mux_init.c
        ${CMAKE_CURRENT_SOURCE_DIR}/${FFMPEG_NAME}/fftools/ffmpeg_opt.c
        ${CMAKE_CURRENT_SOURCE_DIR}/${FFMPEG_NAME}/fftools/objpool.c
        ${CMAKE_CURRENT_SOURCE_DIR}/${FFMPEG_NAME}/fftools/opt_common.c
        ${CMAKE_CURRENT_SOURCE_DIR}/${FFMPEG_NAME}/fftools/sync_queue.c
        ${CMAKE_CURRENT_SOURCE_DIR}/${FFMPEG_NAME}/fftools/thread_queue.c
)
