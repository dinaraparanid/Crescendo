...
private fun VideoCacheService.reportVideoCacheSuccessful() = sendBroadcast(
...
private fun VideoCacheService.reportDownloadError(code: Int, description: String) = sendBroadcast(
...
private fun VideoCacheService.reportVideoCacheCanceled() = sendBroadcast(
    Intent(CacheStatusReceiver.Broadcast_VIDEO_CASH_COMPLETED).putExtra(
        CacheStatusReceiver.VIDEO_CASH_STATUS_ARG,
...
private fun VideoCacheService.reportAudioConversionError() = sendBroadcast(
    Intent(CacheStatusReceiver.Broadcast_VIDEO_CASH_COMPLETED).putExtra(
        CacheStatusReceiver.VIDEO_CASH_STATUS_ARG,
...
private fun VideoCacheService.reportFileCreationError() = sendBroadcast(
    Intent(CacheStatusReceiver.Broadcast_VIDEO_CASH_COMPLETED).putExtra(
        CacheStatusReceiver.VIDEO_CASH_STATUS_ARG,
...
private fun VideoCacheService.reportConnectionLostError() = sendBroadcast(
    Intent(CacheStatusReceiver.Broadcast_VIDEO_CASH_COMPLETED).putExtra(
        CacheStatusReceiver.VIDEO_CASH_STATUS_ARG,
