    ...
    lifecycle.repeatOnLifecycle(Lifecycle.State.STARTED) {
        videoQueueManager.videoQueueFlow
            ...
            .filterNot { _ ->
                ...
                downloadSt == com.paranid5.crescendo.core.common.caching.DownloadingStatus.CanceledAll || cacheSt == com.paranid5.crescendo.core.common.caching.CachingStatus.CANCELED_ALL
            }
            .collect { video -> onCaching(video) }
    }

private suspend inline fun VideoCacheService.onCaching(videoData: com.paranid5.crescendo.core.common.caching.VideoCacheData) {
