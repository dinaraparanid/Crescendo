...
class BlurTransformation(
    ...
    override val cacheKey = "${javaClass.name}-$radius-$sampling"

    override suspend fun transform(input: Bitmap, size: Size) =
        input.blur(sampling, radius) ?: input
...
/** Taken from [here](https://github.com/T8RIN/BlurTransformation/blob/main/BlurTransformation.kt) */

private suspend inline fun Bitmap.blur(sampling: Float, radius: Int) =
