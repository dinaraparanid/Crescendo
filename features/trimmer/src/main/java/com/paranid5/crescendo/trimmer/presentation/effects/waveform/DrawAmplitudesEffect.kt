...
import com.paranid5.crescendo.trimmer.presentation.properties.compose.collectAmplitudesAsState
...
internal fun DrawAmplitudesEffect(
    ...
    val amplitudesRaw by viewModel.collectAmplitudesAsState()
    val amplitudes = remember(amplitudesRaw) { amplitudesRaw.toImmutableList() }
